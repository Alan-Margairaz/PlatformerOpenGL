...
Mesh::~Mesh()
{
	// Nettoie VBO, VAO, texture & évite les pertes de mémoire
...
void Mesh::CreateMesh(GLfloat colorVBO[], const char* objectPath, const char* imagePath, int colorSize, GLuint programID)
{
	...
	model = glm::mat4(1.0f);	// Changer pour chaque modèle
}
...
void Mesh::Draw(GLFWwindow* window, GLuint programID)
{
	...
	// Pour chaque mod le, la MVP sera différente (au moins la partie M)
